...
namespace VehicleManager.Controllers
{
    public class CarsController : Controller
    {
        ...
        //    return View(await carRep.GetByIdAsync(id));
        //}
        ...
        //    }
        //    var car = await carRep.FindAsync(id);
        //    if (car != null)
        //    {
        ...
        //private async bool CarExists(int id)
        //{
        //    //return (_context.Cars?.Any(e => e.CarId == id)).GetValueOrDefault();
        //    //return await carRep.GetAllAsync(a => a.CarId == id);
        //    return await carRep.GetByIdAsync(id);
